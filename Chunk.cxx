...
void Chunk::generateMesh()
{
    ...
    auto appendToBuffer = [&vertices, &indices, &c](glm::vec3 pos, glm::vec2 uv, float brightness)
    {
    ...
    auto cullTopVoxels = [&appendToBuffer](Voxel &voxel, int &x, int &y, int &z, Layer *layers)
    {
        ...
        appendToBuffer(glm::vec3{v0, vz}, glm::vec2{voxel.faceTexture[TOP], 0}, 1.f);
        appendToBuffer(glm::vec3{v1, vz}, glm::vec2{voxel.faceTexture[TOP], 1}, 1.f);
        appendToBuffer(glm::vec3{v2, vz}, glm::vec2{voxel.faceTexture[TOP], 2}, 1.f);
        appendToBuffer(glm::vec3{v2, vz}, glm::vec2{voxel.faceTexture[TOP], 2}, 1.f);
        appendToBuffer(glm::vec3{v3, vz}, glm::vec2{voxel.faceTexture[TOP], 3}, 1.f);
        appendToBuffer(glm::vec3{v0, vz}, glm::vec2{voxel.faceTexture[TOP], 0}, 1.f);
    };
    ...
    auto cullBottomVoxels = [&appendToBuffer](Voxel &voxel, int &x, int &y, int &z, Layer *layers)
    {
        ...
        appendToBuffer(glm::vec3{v0, vz}, glm::vec2{voxel.faceTexture[BOTTOM], 0}, .75f);
        appendToBuffer(glm::vec3{v1, vz}, glm::vec2{voxel.faceTexture[BOTTOM], 1}, .75f);
        appendToBuffer(glm::vec3{v2, vz}, glm::vec2{voxel.faceTexture[BOTTOM], 2}, .75f);
        appendToBuffer(glm::vec3{v2, vz}, glm::vec2{voxel.faceTexture[BOTTOM], 2}, .75f);
        appendToBuffer(glm::vec3{v3, vz}, glm::vec2{voxel.faceTexture[BOTTOM], 3}, .75f);
        appendToBuffer(glm::vec3{v0, vz}, glm::vec2{voxel.faceTexture[BOTTOM], 0}, .75f);
    };
    ...
    auto cullLeftVoxels = [&appendToBuffer, this](Voxel &voxel, int &x, int &y, int &z, Layer *layers)
    {
        ...
        appendToBuffer(glm::vec3{vPos.x - 0.5f, vPos.y + 0.5f, vPos.z - 0.5f}, glm::vec2{voxel.faceTexture[LEFT], 0}, .8f);
        appendToBuffer(glm::vec3{vPos.x + 0.5f, vPos.y + 0.5f, vPos.z - 0.5f}, glm::vec2{voxel.faceTexture[LEFT], 1}, .8f);
        appendToBuffer(glm::vec3{vPos.x + 0.5f, vPos.y + 0.5f, vPos.z + 0.5f}, glm::vec2{voxel.faceTexture[LEFT], 2}, .8f);
        appendToBuffer(glm::vec3{vPos.x + 0.5f, vPos.y + 0.5f, vPos.z + 0.5f}, glm::vec2{voxel.faceTexture[LEFT], 2}, .8f);
        appendToBuffer(glm::vec3{vPos.x - 0.5f, vPos.y + 0.5f, vPos.z + 0.5f}, glm::vec2{voxel.faceTexture[LEFT], 3}, .8f);
        appendToBuffer(glm::vec3{vPos.x - 0.5f, vPos.y + 0.5f, vPos.z - 0.5f}, glm::vec2{voxel.faceTexture[LEFT], 0}, .8f);
    };
    ...
    auto cullRightVoxels = [&appendToBuffer, this](Voxel &voxel, int &x, int &y, int &z, Layer *layers)
    {
        ...
        appendToBuffer(glm::vec3{vPos.x - 0.5f, vPos.y - 0.5f, vPos.z - 0.5f}, glm::vec2{voxel.faceTexture[RIGHT], 0}, .8f);
        appendToBuffer(glm::vec3{vPos.x + 0.5f, vPos.y - 0.5f, vPos.z - 0.5f}, glm::vec2{voxel.faceTexture[RIGHT], 1}, .8f);
        appendToBuffer(glm::vec3{vPos.x + 0.5f, vPos.y - 0.5f, vPos.z + 0.5f}, glm::vec2{voxel.faceTexture[RIGHT], 2}, .8f);
        appendToBuffer(glm::vec3{vPos.x + 0.5f, vPos.y - 0.5f, vPos.z + 0.5f}, glm::vec2{voxel.faceTexture[RIGHT], 2}, .8f);
        appendToBuffer(glm::vec3{vPos.x - 0.5f, vPos.y - 0.5f, vPos.z + 0.5f}, glm::vec2{voxel.faceTexture[RIGHT], 3}, .8f);
        appendToBuffer(glm::vec3{vPos.x - 0.5f, vPos.y - 0.5f, vPos.z - 0.5f}, glm::vec2{voxel.faceTexture[RIGHT], 0}, .8f);
    };
    ...
    auto cullFrontVoxels = [&appendToBuffer, this](Voxel &voxel, int &x, int &y, int &z, Layer *layers)
    {
        ...
        appendToBuffer(glm::vec3{vPos.x - 0.5f, vPos.y - 0.5f, vPos.z - 0.5f}, glm::vec2{voxel.faceTexture[FRONT], 0}, .9f);
        appendToBuffer(glm::vec3{vPos.x - 0.5f, vPos.y + 0.5f, vPos.z - 0.5f}, glm::vec2{voxel.faceTexture[FRONT], 1}, .9f);
        appendToBuffer(glm::vec3{vPos.x - 0.5f, vPos.y + 0.5f, vPos.z + 0.5f}, glm::vec2{voxel.faceTexture[FRONT], 2}, .9f);
        appendToBuffer(glm::vec3{vPos.x - 0.5f, vPos.y + 0.5f, vPos.z + 0.5f}, glm::vec2{voxel.faceTexture[FRONT], 2}, .9f);
        appendToBuffer(glm::vec3{vPos.x - 0.5f, vPos.y - 0.5f, vPos.z + 0.5f}, glm::vec2{voxel.faceTexture[FRONT], 3}, .9f);
        appendToBuffer(glm::vec3{vPos.x - 0.5f, vPos.y - 0.5f, vPos.z - 0.5f}, glm::vec2{voxel.faceTexture[FRONT], 0}, .9f);
    };
    ...
    auto cullBackVoxels = [&appendToBuffer, this](Voxel &voxel, int &x, int &y, int &z, Layer *layers)
    {
        ...
        appendToBuffer(glm::vec3{vPos.x + 0.5f, vPos.y - 0.5f, vPos.z - 0.5f}, glm::vec2{voxel.faceTexture[BACK], 0}, .9f);
        appendToBuffer(glm::vec3{vPos.x + 0.5f, vPos.y + 0.5f, vPos.z - 0.5f}, glm::vec2{voxel.faceTexture[BACK], 1}, .9f);
        appendToBuffer(glm::vec3{vPos.x + 0.5f, vPos.y + 0.5f, vPos.z + 0.5f}, glm::vec2{voxel.faceTexture[BACK], 2}, .9f);
        appendToBuffer(glm::vec3{vPos.x + 0.5f, vPos.y + 0.5f, vPos.z + 0.5f}, glm::vec2{voxel.faceTexture[BACK], 2}, .9f);
        appendToBuffer(glm::vec3{vPos.x + 0.5f, vPos.y - 0.5f, vPos.z + 0.5f}, glm::vec2{voxel.faceTexture[BACK], 3}, .9f);
        appendToBuffer(glm::vec3{vPos.x + 0.5f, vPos.y - 0.5f, vPos.z - 0.5f}, glm::vec2{voxel.faceTexture[BACK], 0}, .9f);
    };
