...
#define BLK_EXTENT 16
#define BLK_LAYER_COUNT 32
...
private:
  ...
  // for ImageSampler2DArray

  std::unique_ptr<TextureArray2D> blockTextureArray2D;
  ...
  const std::string TEXTURE_PATH =
      "/home/divyansh/MinecraftClone/textures/atlas.png";
