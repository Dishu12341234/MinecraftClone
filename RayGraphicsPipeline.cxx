...
void RayGraphicsPipeline::createGraphicsPipeline()
{
    std::cout << "Creating Ray Graphics Pipeline..." << std::endl;

    auto vertShaderCode = readFile("/home/divyansh/MinecraftClone/shaders/simple_shader_ray_v.spv");
    auto fragShaderCode = readFile("/home/divyansh/MinecraftClone/shaders/simple_shader_ray_f.spv");
    ...
    auto bindingDescription = RayPoints::getBindingDescription();
    auto attributeDescriptions = RayPoints::getAttributeDescriptions();
...
VkVertexInputBindingDescription RayPoints::getBindingDescription()
{
    ...
    bindingDescription.stride = sizeof(RayPoints);
    bindingDescription.inputRate = VK_VERTEX_INPUT_RATE_VERTEX; // advance to the next input per vertex

    return bindingDescription;
}

std::array<VkVertexInputAttributeDescription, 2> RayPoints::getAttributeDescriptions()
{
    ...
    attributeDescriptions[0].offset = offsetof(RayPoints, pos);

    attributeDescriptions[1].binding = 0;
    attributeDescriptions[1].location = 1;
    attributeDescriptions[1].format = VK_FORMAT_R32G32B32_SFLOAT; // vec3
    attributeDescriptions[1].offset = offsetof(RayPoints, color);
