...
template <typename T>
Mesh<T>::Mesh(VulkanContext &vkContext) : vkContext{vkContext} {}

template <typename T>
void Mesh<T>::loadVertices(const std::vector<T> &vertices) {
  this->vertices = vertices;
}

template <typename T>
void Mesh<T>::loadIndices(const std::vector<uint32_t> &indices) {
  this->indices = indices;
}

template <typename T> void Mesh<T>::createVertexBuffer() {
...
template <typename T> void Mesh<T>::createIndexBuffer() {
...
template <typename T> void Mesh<T>::updateVertexBuffer() {
...
template <typename T> void Mesh<T>::updateIndexBuffer() {
...
template <typename T> void Mesh<T>::cleanup() {
...
template class Mesh<FontVertex>;
