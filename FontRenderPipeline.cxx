...
void FontRenderPipeline::createGraphicsPipeline() {
  std::cout << "Creating Graphics Pipeline..." << std::endl;

  auto vertShaderCode = readFile(
      "/home/divyansh/MinecraftClone/shaders/simple_font_shader_v.spv");
  auto fragShaderCode = readFile(
      "/home/divyansh/MinecraftClone/shaders/simple_font_shader_f.spv");
  ...
  auto attributeDescriptions = FontVertex::getAttributeDescriptions();
...
FontVertex::getAttributeDescriptions() {
  ...
  attributeDescriptions[1].offset = offsetof(FontVertex, uv);
  // -> === == != <= >= |= ^= /=
